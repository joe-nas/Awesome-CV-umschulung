  ...
  \cventry
    ...
    {2018 - 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \vspace{0.2cm}
        \newline\badge[awesome-skyblue]{Teamwork} \badge[awesome-skyblue]{KNAPP} \badge[awesome-skyblue]{KiSoft}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \vspace{0.2cm}
        \newline\badge[awesome-skyblue]{R} \badge[awesome-skyblue]{GGPLOT} \badge[awesome-skyblue]{BASH} \badge[awesome-skyblue]{Datenintegration} 
        \badge[awesome-skyblue]{Datenanalyse} \badge[awesome-skyblue]{Visualisierung} \badge[awesome-skyblue]{LaTeX}
      \end{cvitems}
    }
    ...
    {November 2015 - 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \vspace{0.2cm}
        \newline\badge[awesome-skyblue]{R} \badge[awesome-skyblue]{GGPLOT} \badge[awesome-skyblue]{Datenintegration} \badge[awesome-skyblue]{Datenanalyse} 
        \badge[awesome-skyblue]{Visualisierung} \badge[awesome-skyblue]{Office}
      \end{cvitems}
    }
